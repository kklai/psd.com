<?php get_header(); ?>
        ...
        <div class="mission">
          <h1><span>Promotional Student Design</span></h1>
          <p>Our group gathers graphic designers in the NU community. We focus on promoting and handling public relations of various student clubs and teaching other students the basics of graphic design.</p>
        </div>
